...
android {
    ...
    // Required to use resValue() for the per-flavor app name.
    buildFeatures {
        resValues = true
    }
    ...
    defaultConfig {
        ...
        applicationId = "app.curious.sudoku"
    ...
    buildTypes {
        ...
        // id (.testing) and the name "Sudoku Testing". All levels are unlocked
        // (kDebugMode) so testers can play any level.
        getByName("debug") {
            applicationIdSuffix = ".testing"
            resValue("string", "app_name", "Sudoku Testing")
        }
        // Release = the production build: "Sudoku", levels locked until cleared.
